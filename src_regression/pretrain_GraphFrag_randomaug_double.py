...
from datasets_complete_feature import Molecule3DDatasetFragRandomaugDoubleComplete
...
if __name__ == "__main__":
    ...
    if 'GEOM' in args.dataset:
        ...
        n_mol = args.n_mol
        root_2d = '{}/GEOM_2D_nmol{}_any_morefeat'.format(args.data_folder, args.n_mol)
        print('%s/processed/smiles.csv' % root_2d)
        dataset = Molecule3DDatasetFragRandomaugDoubleComplete(root=root_2d, n_mol=n_mol,
