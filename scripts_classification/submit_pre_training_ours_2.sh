...
export dataset=GEOM_2D_nmol50000_cut_CCsinglebond
...
export mode_list=(GraphFrag_randomaug_double)

for mode in "${mode_list[@]}"; do
     export folder="$mode"/"$dataset"/epochs_"$epochs"_"$dropout_ratio"_alin9
     echo "$folder"
