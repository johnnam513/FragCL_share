...
export dataset=GEOM_2D_3D_nmol50000_cut_singlebond_manual_0911_angles
...
export mode_list=(fragcl3d_angles)

for mode in "${mode_list[@]}"; do
     export folder="$mode"/"$dataset"/epochs_"$epochs"_"$dropout_ratio"_aug_"$aug_strength"_0912
     echo "$folder"
