...
GraphFrag_zinc/molecule_datasets/zinc_standard_agent_check/epochs_100_0_cut_branch
GraphFrag_zinc_randomaug/molecule_datasets/zinc_standard_agent_check/epochs_100_0
...
for mode in "${mode_list[@]}"; do
    ...
    ls ../output/"$mode"
    ls
    bash run_fine_tuning_model_5.sh "$mode"
