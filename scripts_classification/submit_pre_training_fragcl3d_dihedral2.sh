...
#export dataset=GEOM_2D_3D_nmol50000_cut_singlebond_manual_1110_sorted_dihedral_from_frag_nohydanchor_0.5
export dataset=GEOM_2D_3D_nmol50000_anybond_manual_1110_sorted_dihedral_from_frag_nohydanchor
...
export mode_list=(fragcl3d_dihedral2)

for mode in "${mode_list[@]}"; do
     export folder="$mode"/"$dataset"/epochs_"$epochs"_"$dropout_ratio"_aug_"$aug_strength"_33
     echo "$folder"
