...
export dataset=GEOM_2D_nmol50000_4frag_cut_singlebond
...
export mode_list=(FragCL_4frags)

for mode in "${mode_list[@]}"; do
     export folder="$mode"/"$dataset"/epochs_"$epochs"_"$dropout_ratio"_"$aug_mode"_"$aug_strength"_3
     echo "$folder"
