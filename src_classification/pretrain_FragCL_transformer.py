...
def main():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        train_loss = train(loader, model, optimizer, device)

        #print(train_acc)
        print(train_loss)

        if epoch % 20 == 0:
            torch.save(gnn.state_dict(), "./model/FragCL_" + str(epoch) + ".pth")
            torch.save(model.pool.state_dict(), "./model/FragCL_aggregator_" + str(epoch) + ".pth")
