...
def train(loader, model, optimizer, device):
    ...
    for step, (first_batch, first_batch1, first_batch2, second_batch, second_batch1, second_batch2) in enumerate(loader):
        ...
        loss2 = model.loss_cl(second_x[:,150:], second_x2[:,150:])
...
if __name__ == "__main__":
    ...
    dataset = Molecule3DDatasetFragRandomaugDouble(root='{}/molecule_datasets/zinc_standard_agent_keep_branch'.format(args.data_folder))
