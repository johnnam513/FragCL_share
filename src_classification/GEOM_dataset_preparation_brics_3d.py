        ...
        if self.smiles_copy_from_3D_file is None:  # 3D datasets
            ...
            for smiles in tqdm(data_smiles_list):
                ...
                with open(mol_path, 'rb') as f:
                    ...
                    try:
                        for mol in mols:
                            brics_data.append(mol_to_graph_data_obj_simple_3D_gen(mol))
...
if __name__ == '__main__':
    ...
    if args.sum:
        ...
        n_mol = args.n_mol
        root_2d = '{}/GEOM_2D_3D_nmol{}_brics_coarse'.format(data_folder, n_mol)
        ...
        Molecule3DDatasetFrag(root=root_2d, n_mol=n_mol,
                          smiles_copy_from_3D_file='/home/osikjs/GraphMVP/datasets/GEOM_2D_3D_nmol50000_anybond_manual_1110_sorted_dihedral_from_frag_nohydanchor/processed/smiles.csv')
