...
from util import dual_CL, dual_Frag_CL
...
def train(args, molecule_model_2D, molecule_model_3D, device, loader, optimizer, epoch):
    ...
    for step, (batch, batch1, batch2, orig_batch, orig_batch1, orig_batch2) in enumerate(l):
        ...
        CL_loss1, CL_acc1 = dual_CL(molecule_2D_repr, molecule_3D_repr, args)
        CL_loss2, CL_acc2 = dual_Frag_CL(molecule_2D_repr, frag_2D_repr1, frag_2D_repr2, molecule_3D_repr, frag_3D_repr1, frag_3D_repr2, args)
        CL_loss = (CL_loss1 + CL_loss2)/2
        CL_acc = (CL_acc1 + CL_acc2)/2
