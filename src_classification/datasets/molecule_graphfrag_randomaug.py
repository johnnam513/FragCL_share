...
class Molecule3DDatasetFragRandomaug2(MoleculeDataset):
    ...
    def __init__(self, root, n_mol,choose = 0,transform=None, seed=777,
        ...
        self.augmentations = [self.node_drop, self.subgraph,
                              self.edge_pert, self.attr_mask, lambda x: x]
        super(Molecule3DDatasetFragRandomaug2, self).__init__(
            root, transform, pre_transform, pre_filter)
    ...
    def get(self, idx):
        ...
        if self.aug_mode == 'no_aug':
            ...
            n_aug = np.random.choice(3,1)[0]
            n_aug0 = np.random.choice(3,1)[0]
            n_aug1 = np.random.choice(3,1)[0]
            n_aug2 = np.random.choice(3,1)[0]
            org_data1 = two_augmentations[n_aug](data.clone())
            org_data2 = two_augmentations[n_aug0](data.clone())
            data1 = two_augmentations[n_aug1](data1.clone())
            data2 = two_augmentations[n_aug2](data2.clone())
        elif self.aug_mode == 'molclr':
            if self.choose == 0:
            ...
            raise ValueError
        return org_data1, org_data2, data1, data2
