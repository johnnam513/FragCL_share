        ...
        if self.smiles_copy_from_3D_file is None:  # 3D datasets
            ...
            for smiles, sub_dic in tqdm(drugs_summary):
                ...
                with open(mol_path, 'rb') as f:
                    ...
                    for conformer_dict in conformer_list:
                        # select the first n_conf conformations
                        if conformer_dict['relativeenergy']==0.0:
                            rdkit_mol = conformer_dict['rd_mol']
                            #print(conformer_dict['relativeenergy'])
                            data = mol_to_graph_data_obj_simple_3D(rdkit_mol)
...
if __name__ == '__main__':
    ...
    if args.sum:
        ...
        root_2d = '{}/GEOM_2D_nmol{}_ground_nupper{}'.format(data_folder, n_mol, n_upper)
        root_3d = '{}/GEOM_3D_nmol{}_ground_nupper{}'.format(data_folder, n_mol, n_upper)
