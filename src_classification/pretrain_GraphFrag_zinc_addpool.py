...
from datasets import MoleculeDatasetFrag
...
if __name__ == "__main__":
    ...
    #    n_mol = args.n_mol
    #    root_2d = '{}/GEOM_2D_nmol{}'.format(args.data_folder, args.n_mol)
    ...
    dataset = MoleculeDatasetFrag(root='{}/molecule_datasets/zinc_standard_agent'.format(args.data_folder))
    print(dataset)
