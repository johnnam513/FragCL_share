...
class Molecule3DDatasetFrag(InMemoryDataset):
    ...
    def process(self):
        ...
        data0_0_smiles_series.to_csv(saver_path + "_1", index=False, header=False)
        data0_1_smiles_series.to_csv(saver_path + "_2", index=False, header=False)

        torch.save((data0_0, slices0_0), self.processed_paths[0] + "_1")
        torch.save((data0_1, slices0_1), self.processed_paths[0] + "_2")
...
if __name__ == '__main__':
    ...
    if args.sum:
        ...
        n_mol = args.n_mol
        root_2d = '{}/GEOM_2D_nmol{}_frag_cut_singlebond'.format(data_folder, n_mol)
        ...
        Molecule3DDatasetFrag(root=root_2d, n_mol=n_mol,
                          smiles_copy_from_3D_file='../smiles.csv')
