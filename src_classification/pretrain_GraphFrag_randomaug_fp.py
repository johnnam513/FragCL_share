...
def train(loader, model, optimizer, device, old, thres):
    ...
    for step, (batch, batch1, batch2) in enumerate(loader):
        ...
        if old == 1:
            ...
            x2, frag1, frag2 = model.weighted_forward_frag_cl(batch1.x, batch1.edge_index,
                                ...
                                batch2.x, batch2.edge_index,
                                batch2.edge_attr, batch2.batch)
            loss = model.loss_cl_fp_onlyneg(x, x2, frag1, frag2, batch.fp.reshape(x.size(0), -1), thres, batch1.batch, batch2.batch)
...
if __name__ == "__main__":
    ...
    if 'GEOM' in args.dataset:
        n_mol = args.n_mol
        root_2d = '{}/GEOM_2D_nmol{}_cut_singlebond_fp'.format(args.data_folder, args.n_mol)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        pretrain_loss = train(loader, model, optimizer, device, args.old, args.threshold)
