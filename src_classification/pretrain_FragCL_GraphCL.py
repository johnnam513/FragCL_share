...
from datasets import Molecule3DDatasetFragRandomaug2
...
def train(loader, model, optimizer, device):
    ...
    for step, (batch, batch0, batch1, batch2) in enumerate(loader):
        ...
        x1, frag1, frag2 = model.weighted_forward_frag_cl(batch1.x, batch1.edge_index,
                            batch1.edge_attr, batch1.batch,
                            batch2.x, batch2.edge_index,
                            batch2.edge_attr, batch2.batch)
        
        loss1 = model.weighted_loss_cl_onlyneg(x, x1, frag1, frag2, batch1.batch, batch2.batch)
        loss2 = model.weighted_loss_cl_onlyneg(x0, x1, frag1, frag2, batch1.batch, batch2.batch)
        loss3 = model.loss_cl_old(x, x0)
        loss4 = model.loss_cl_old(x0, x)
...
if __name__ == "__main__":
    ...
    if 'GEOM' in args.dataset:
        ...
        dataset = Molecule3DDatasetFragRandomaug2(root=root_2d, n_mol=n_mol, choose=args.choose,
