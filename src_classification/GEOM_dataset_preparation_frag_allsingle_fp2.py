...
def mol_to_graph_data(mol):
    ...
    fp2 = torch.Tensor(fp1)
    fp2 = DataStructs.ExplicitBitVect(fp2)
    data = Data(x=x, edge_index=edge_index,
                edge_attr=edge_attr, positions=None, fp=fp)
    return data
...
if __name__ == '__main__':
    ...
    if args.sum:
        ...
        n_mol = args.n_mol
        root_2d = '{}/GEOM_2D_nmol{}_cut_singlebond_fp'.format(data_folder, n_mol)
