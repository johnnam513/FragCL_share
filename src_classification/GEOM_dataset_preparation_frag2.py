...
if __name__ == '__main__':
    ...
    if args.sum:
        ...
        n_mol = args.n_mol
        root_2d = '{}/GEOM_2D_nmol{}_morefeat'.format(data_folder, n_mol)
        ...
        Molecule3DDatasetFrag(root=root_2d, n_mol=n_mol,
                          smiles_copy_from_3D_file='/home/osikjs/GraphMVP/datasets/GEOM_2D_nmol50000_bug/processed/smiles_tmp.csv' % root_2d)
