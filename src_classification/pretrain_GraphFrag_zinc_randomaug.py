...
from datasets import MoleculeDatasetFragRandomaug
...
if __name__ == "__main__":
    ...
    dataset = MoleculeDatasetFragRandomaug(root='{}/molecule_datasets/zinc_standard_agent_any'.format(args.data_folder))
